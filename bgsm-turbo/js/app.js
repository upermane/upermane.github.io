 ...
 */
    ...
    (() => {
        ...
        !function() {
            ...
            var t = "required", i = "email", r = "minLength", n = "maxLength", o = "password", s = "zip", a = "phone", l = "remote", u = "strength", d = "function", c = function(e, t) {
                ...
                var a = !1 !== e.async, l = new XMLHttpRequest, u = c(r, "get"), d = null;
                "post" === i.toLowerCase() && (d = c(r, "post"), u = ""), l.open(i, t + u, a), l.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), 
                l.onreadystatechange = function() {
                    4 === this.readyState && (200 === this.status ? o(this.responseText) : s && s(this.responseText));
                }, l.send(d);
            }, f = function(e, t) {
                this.options = t || {}, this.rules = this.options.rules || {}, this.messages = this.options.messages || void 0, 
                this.colorWrong = this.options.colorWrong || "#B81111", this.result = {}, this.elements = [], 
                this.tooltip = this.options.tooltip || {}, this.tooltipFadeOutTime = this.tooltip.fadeOutTime || 5e3, 
                ...
                this.bindHandlerKeyup = this.handlerKeyup.bind(this), this.submitHandler = this.options.submitHandler || void 0, 
                this.invalidFormCallback = this.options.invalidFormCallback || void 0, this.promisesRemote = [], 
                this.isValidationSuccess = !1, this.focusWrongField = this.options.focusWrongField || !1, 
                this.REGEXP = {
            ...
            f.prototype = {
                ...
                generateMessage: function(e, t, i) {
                    var r = this.messages || this.defaultMessages, n = r[t] && r[t][e] || this.messages && "string" == typeof this.messages[t] && r[t] || this.defaultMessages[e] || this.DEFAULT_REMOTE_ERROR;
                ...
                validateElements: function() {
                    ...
                    return this.lockForm(), this.elements.forEach((function(t) {
                        ...
                        t.forEach((function(t) {
                            ...
                            e.generateMessage(l, t.name), void e.renderErrors());
                        }));
                    })) : void this.renderErrors();
                },
                validateItem: function(e) {
                    var c = this, h = e.name, f = e.group, m = e.value, v = e.isKeyupChange, p = this.rules[h] || this.defaultRules[h] || !1;
                    if (p) for (var g in p) {
                        var y = p[g];
                        if (g !== t && g !== d && "" == m) return;
                        switch (g) {
                          ...
                          case l:
                            if (v) break;
                            if (!y) break;
                            var k = y.url, _ = y.successAnswer, P = y.method, R = y.sendParam, S = this.$form.querySelector('input[data-validate-field="' + h + '"]');
                ...
                clearErrors: function() {
                    ...
                    for (var r = 0, n = e.length; r < n; ++r) e[r].classList.remove("js-validate-error-field"), 
                    e[r].style.border = "", e[r].style.color = "";
                },
                renderErrors: function() {
                    ...
                    for (var t in this.result) {
                        var i = this.result[t].message, r = this.$form.querySelectorAll('[data-validate-field="' + t + '"]'), n = r[r.length - 1], o = document.createElement("div");
                        if (o.innerHTML = i, o.className = "js-validate-error-label", o.setAttribute("style", "color: " + this.colorWrong), 
                        n.style.border = "1px solid " + this.colorWrong, n.style.color = "" + this.colorWrong, 
                        n.classList.add("js-validate-error-field"), "checkbox" === n.type || "radio" === n.type) {
                ...
                lockForm: function() {
                    for (var e = this.$form.querySelectorAll("input, textarea, button, select"), t = 0, i = e.length; t < i; ++t) e[t].setAttribute("disabled", "disabled"), 
                    e[t].style.pointerEvents = "none", e[t].style.webitFilter = "grayscale(100%)", e[t].style.filter = "grayscale(100%)";
                },
                unlockForm: function() {
                    for (var e = this.$form.querySelectorAll("input, textarea, button, select"), t = 0, i = e.length; t < i; ++t) e[t].removeAttribute("disabled"), 
                    e[t].style.pointerEvents = "", e[t].style.webitFilter = "", e[t].style.filter = "";
                }
            }, e.JustValidate = f;
        }(window);
        ...
        const quizData = [ {
            number: 1,
            title: "Какой объект Вы хотите продать?",
            ...
            answers: [ {
                ...
                img: "",
                checked: "",
                classList: "quiz__question1 quiz__object"
            }, {
                answer_title: "Комната",
                type: "radio",
                value: "Комната",
                img: "",
                checked: "",
            ...
            number: 2,
            title: "Укажите адрес и параметры квартиры",
            answer_alias: "Адрес",
            answers: [ {
                answer_title: "Улица",
                value: "",
                type: "text",
                classList: "quiz__question2 quiz__ul"
            }, {
                answer_title: "Номер дома",
                value: "",
                type: "text",
                classList: "quiz__question2 quiz__house"
            }, {
                answer_title: "Площадь",
                additional_answer_title: "",
                value: "",
                type: "square",
                max: 99990,
                min: 1,
                classList: "quiz__question2 quiz__square"
            }, {
                answer_title: "Этаж",
                additional_answer_title: "",
                value: "",
                ...
                min: -1,
                max: 19e4,
                classList: "quiz__question2 quiz__floor"
            } ]
        }, {
            number: 3,
            title: "Какую сумму Вы ожидаете получить от продажи Вашей недвижимости?",
            answer_alias: "Ожидаймая сумма",
            answers: [ {
                answer_title: "Стоимость объекта",
                type: "number",
                min: 0,
                max: 9e16,
                classList: "quiz__question3"
            } ]
        }, {
            number: 4,
            title: "Укажите сумму долга?",
            answer_alias: "Сумма долга",
            answers: [ {
                answer_title: "Сумма долга",
                type: "number",
                min: 0,
                max: 9e16,
                classList: "quiz__question3"
            ...
            number: 5,
            title: "В какой срок Вам нужны деньги?",
            answer_alias: "В какой срок нужны деньги",
            answers: [ {
                answer_title: "до 7 дней",
                type: "radio",
                value: "до 7 дней",
                img: "",
                checked: "",
                classList: "quiz__question1 quiz__time"
            }, {
            ...
            answer_alias: "Способ связи",
            answers: [ {
                answer_title: "Перезвонить",
                type: "radio",
                img: "img/phone.png",
                value: "телефон",
                checked: "",
                classList: "quiz__question1 quiz__icon"
            }, {
                answer_title: "Написать в",
                type: "radio",
            ...
            answer_alias: "Контакты",
            answers: [ {
                answer_title: "Имя",
                value: "",
                type: "text",
                classList: "quiz__question2"
            }, {
        ...
        let resultArray = [];
        const start = () => {
            main.innerHTML = `\n        <form class="quiz" target="myIFR" method="POST"></form>\n`;
        ...
        const startQuiz = () => {
            main = document.querySelector(`div[class=question]`);
            SIZE = quizData.length;
            start();
        };
        const changeValueText = item => {
            item.classList.remove("error");
        };
        const changeValueNumber = (item, max, min) => {
            if (parseInt(item.value) < parseInt(min)) item.value = min;
            if (parseInt(item.value) > parseInt(max)) item.value = max;
        };
        let squareLength = 0;
        const inputValueSquare = (item, max, min) => {
            let arrayOfSquares = item.value.split(";");
            let isValid = true;
            let value = item.value.split("");
            if (item.value.charAt(item.value.length - 1) >= 0 && item.value.charAt(item.value.length - 1) <= 9 && "." != item.value[item.value.length - 2]) {
                if (squareLength < item.value.length) if (" " == item.value[item.value.length - 1]) if (arrayOfSquares.length < 3) {
                    for (let e in arrayOfSquares) if ("  " == arrayOfSquares[e] || 1 === item.value.length) isValid = false;
                    if (isValid) {
                        item.value = "";
                        for (let i = 0; i < arrayOfSquares.length; i++) if ("  " != arrayOfSquares[i]) {
                            if (parseInt(arrayOfSquares[i], 10) > max) if (i > 0) arrayOfSquares[i] = ` ${max} `; else arrayOfSquares[i] = `${max} `;
                            if (parseInt(arrayOfSquares[i], 10) < min) if (i > 0) arrayOfSquares[i] = ` ${min} `; else arrayOfSquares[i] = `${min} `;
                            if (1 == arrayOfSquares.length) item.value += arrayOfSquares[i]; else if (0 == i) item.value += arrayOfSquares[i] + ";"; else item.value += arrayOfSquares[i];
                        }
                        value = item.value.split("");
                        value[value.length - 1] = "; ";
                        item.value = "";
                        for (let i = 0; i < value.length; i++) item.value += value[i];
                    } else {
                        item.value = "";
                        for (let i = 0; i < arrayOfSquares.length - 1; i++) item.value += arrayOfSquares[i] + "; ";
                    }
                } else if ("." != item.value[item.value.length - 2] && ";" != item.value[item.value.length - 3]) {
                    if (parseInt(arrayOfSquares[2], 10) > max) arrayOfSquares[2] = ` ${max} `;
                    if (parseInt(arrayOfSquares[2], 10) < min) arrayOfSquares[2] = ` ${min} `;
                    item.value = "";
                    item.value += arrayOfSquares[0] + ";";
                    item.value += arrayOfSquares[1] + ";";
                    item.value += arrayOfSquares[2];
                    value = item.value.split("");
                    value[value.length - 1] = ".";
                    item.value = "";
                    for (let i = 0; i < value.length; i++) item.value += value[i];
                    ...
                    item.value = "";
                    for (let i = 0; i < value.length - 1; i++) item.value += value[i];
                }
            } else {
                item.value = "";
                for (let i = 0; i < value.length - 1; i++) item.value += value[i];
            }
            squareLength = item.value.length;
            helperAlert(item);
        };
        const changeValueSquare = (item, max, min) => {
            let arrayOfSquares = item.value.split(";");
            if (3 == arrayOfSquares.length) if ("." != item.value[item.value.length - 1] && " " != item.value[item.value.length - 1]) {
                if (parseInt(arrayOfSquares[2], 10) > max) arrayOfSquares[2] = ` ${max}`;
                if (parseInt(arrayOfSquares[2], 10) < min) arrayOfSquares[2] = ` ${min}`;
                item.value = "";
                item.value += arrayOfSquares[0] + ";";
        ...
        const btnNextSquare = (max, min) => {
            let item = document.querySelector("input[name='square']");
            let arrayOfSquares = item.value.split(";");
            let len = arrayOfSquares.length - 1;
            let value = "";
            if ("." != item.value[item.value.length - 1] && " " != item.value[item.value.length - 1] && "" != item.value) {
                if (parseInt(arrayOfSquares[len], 10) > max) arrayOfSquares[len] = ` ${max}`;
                if (parseInt(arrayOfSquares[len], 10) < min) arrayOfSquares[len] = ` ${min}`;
                for (let i = 0; i < len; i++) value += arrayOfSquares[i] + ";";
                value += arrayOfSquares[len];
                if (2 == len) value += "."; else value += "; ";
                item.value = "";
                for (let i = 0; i < value.length; i++) item.value += value[i];
            }
        };
        const helperAlert = item => {
            let helper = document.querySelector("#helper");
            let textArray = [ "Общая площадь", "Жилая площадь", "Площадь кухни" ];
            let textNextHelper = "Нажмите пробел, что бы ввести следующий показатель";
            let valueArr = item.value.split("; ");
            let lenValueArr = valueArr.length;
            let len = 0;
            if (" " != item.value[item.value.length - 1] || "" === valueArr[lenValueArr - 1]) lenValueArr--;
            for (let i = 0; i < lenValueArr; i++) len += valueArr[i].length + 2;
            helper.style.display = "block";
            if (" " == item.value[item.value.length - 1] || 2 != lenValueArr) {
                if (" " == item.value[item.value.length - 1] || 0 == item.value.length) helper.querySelector("a").innerHTML = textArray[lenValueArr]; else helper.querySelector("a").innerHTML = textNextHelper;
                helper.style.marginLeft = 10 * len - 10 + "px";
            } else helperAlertOut();
        };
        const helperAlertOut = () => {
        ...
        function mask(e) {
            var matrix = "+7(___)___-__-__", i = 0, def = matrix.replace(/\D/g, ""), val = e.value.replace(/\D/g, "");
            if (val.length <= 11) {
                ...
                i < matrix.length && matrix != e.placeholder ? i++ : i = matrix.indexOf("_");
                setCursorPosition(i, e);
            } else {
                let value = e.value;
                e.value = "";
                for (let i = 0; i < value.length - 1; i++) e.value += value[i];
            }
        }
        const quizTemplate = (data = [], dataLength, options) => {
            ...
            const answers = data.answers.map((item => {
                switch (item.type) {
                  case "tel":
                    return `\n                                <label  class="${item.classList}">\n                                    <input required="true" type="${item.type}" name="tel" pattern="\\+7\\s?[\\(]{0,1}9[0-9]{2}[\\)]{0,1}\\s?\\d{3}[-]{0,1}\\d{2}[-]{0,1}\\d{2}" placeholder="${item.answer_title}" class="quiz-question__answer">\n                               </label>\n                                `;
                    break;

                  case "radio":
                    return `\n                                <label class="${item.classList}">\n                                    <input type="radio" name="group">\n                                    <span class="placeholder-quiz">${item.answer_title}${item.img ? `<img src="${item.img}">` : ""}</span>\n                                </label>\n                            `;
                    break;

                  case "text":
                    return `\n                                <label class="${item.classList}">\n                                    <input required="true" name="text"  type="text" class="text">\n                                    <span class="placeholder-quiz">${item.answer_title}</span>\n                                </label>\n                            `;
                    break;

                  case "square":
                    return `\n                                <label class="${item.classList}">\n                                    <input required="true" name="square" type="square"   max="${item.max}" min="${item.min}" class="quiz-question__answer">\n                                    <span class="placeholder-quiz">${item.answer_title}</span>\n                                    <div id="helper" style="display: none">\n                                        <div id="helperArrow"></div>\n                                        <a>Общая площадь</a>\n                                    </div>\n                              </label>\n                            `;
                    break;

                  case "number":
                    return `\n                                <label class="${item.classList}">\n                                    <input required="true" type="number" name="number" max="${item.max}" min="${item.min}" class="quiz-question__answer">\n                                    ${item.additional_answer_title ? `<span class="additional-placeholder-quiz">${item.additional_answer_title} </span>` : ""}\n                                    <span class="placeholder-quiz">${item.answer_title}</span>\n                              </label>\n                            `;
                    break;

                  default:
                    return `\n                                <label  class="${item.classList}">\n                                    <input required="true" type="${item.type}" class="quiz-question__answer">\n                                    <span class="placeholder-quiz">${item.answer_title}</span>\n                                </label>\n                                `;
                    break;
                }
            }));
            return `\n    <div class="container quiz__container">\n    <h2 class="title quiz__title">Рассчитайте за сколько мы купим Ваш объект</h2>\n    <p class="quiz__desc">Ответьте на вопросы и узнайте, как дорого мы оценим Вашу квартиру</p>\n    <div class="quiz__content">\n        <h3 class="quiz-question__title">${number}. ${title}</h3>\n        <div class="quiz-question__answers">\n            ${answers.join("")}\n            <div class="btn__quizs">\n                <button type="submit" class="quiz-question__btn btn btn-reset btn--quiz btn--quiz-next"  ${SIZE > number ? "data-next-btn" : "data-send"}>${SIZE > number ? nextBtnText : sendBtnText}</button>\n            </div>\n        </div>\n        <div class="label__wrapp">\n                        ${SIZE === number ? "<label>" + "<input type='checkbox' id='agreement'>" + "<span>Я согласен(на) на обработку персональных данных</span>" + "</label>" : ""}\n        </div>\n    </div>\n    </div>\n    `;
        };
        class Quiz {
            ...
            events() {
                this.$el.addEventListener("click", (e => {
                    if (e.target == document.querySelector("[data-next-btn]")) {
                        if (1 === this.counter) btnNextSquare(this.data[1].answers[3].max, this.data[1].answers[3].min);
                        if (this.valid()) this.tmp = this.serialize(this.$el);
                        this.addToSend();
                        this.nextQuestion();
                    }
                    if (e.target == document.querySelector("[data-send]")) if (this.valid()) {
                        ...
                        if (document.querySelector("#agreement").checked) {
                            ...
                            this.send();
                            this.close();
                        } else document.querySelector("#agreement").classList.add("error");
                    }
                }));
            }
            nextQuestion() {
                if (this.valid()) {
                    ...
                    if (this.counter + 1 < this.dataLength) {
                        this.counter++;
                        this.$el.innerHTML = quizTemplate(quizData[this.counter], this.dataLength, this.options);
                        this.$el.querySelectorAll("input[name=text]").forEach((el => {
                            el.addEventListener("input", (e => {
                                changeValueText(e.target);
                            }));
                        }));
                        this.$el.querySelectorAll("input[name=tel]").forEach((el => {
                            el.addEventListener("input", (e => {
                                mask(e.target);
                            }));
                        }));
                        ...
                        this.$el.querySelectorAll("input[name=tel]").forEach((el => {
                            el.addEventListener("blur", (e => {
                                if ("+7(___)___-__-__" == e.target.value) e.target.value = "";
                            }));
                        }));
                        this.$el.querySelectorAll("input[name=square]").forEach((el => {
                            el.addEventListener("input", (e => {
                                inputValueSquare(e.target, e.target.max, e.target.min);
                            }));
                        }));
                        this.$el.querySelectorAll("input[name=square]").forEach((el => {
                            el.addEventListener("change", (e => {
                                changeValueSquare(e.target, e.target.max, e.target.min);
                            }));
                        }));
                        this.$el.querySelectorAll("input[name=square]").forEach((el => {
                            el.addEventListener("focus", (e => {
                                helperAlert(e.target);
                            }));
                        }));
                        this.$el.querySelectorAll("input[name=square]").forEach((el => {
                            el.addEventListener("blur", (e => {
                        ...
                        this.$el.querySelectorAll("input[name=number]").forEach((el => {
                            el.addEventListener("change", (e => {
                                changeValueNumber(e.target, e.target.max, e.target.min);
                            }));
                        }));
                    }
                }
            ...
            valid() {
                ...
                let radioElements = this.$el.querySelectorAll("input[type=radio]");
                ...
                elements.forEach((el => {
                    switch (el.type) {
                      case "text":
                        if (el.min) {
                            if (!el.value || "." != el.value[el.value.length - 1]) {
                                isValid = false;
                                helperAlert(el);
            ...
            addToSend() {
                resultArray[this.counter] = this.tmp;
            }
            send() {
                if (this.valid()) {
                    console.log("send!");
                    ...
                    for (let item of resultArray) for (let obj in item) if (!Array.isArray(item[obj])) formData.append(obj, item[obj].substring(0, item[obj].length)); else formData.append(obj, item[obj].join("").substring(0, item[obj].join("").length));
                    const sendByMail = fetch("../files/sendmail/sendmail.php", {
                        method: "POST",
                        body: formData,
                        mode: "no-cors"
                        ...
                        console.log("200 - ok");
                        setTimeout((() => document.getElementById("send-200").click()), 1e3);
                    })).catch((function(error) {
                        console.log("404 Not Found : " + error);
                        setTimeout((() => document.getElementById("send-404").click()), 1e3);
                    }));
                    console.log(sendByMail);
                }
            }
            serialize(form) {
                let elements = form.querySelector(".quiz-question__answers").children;
                let field, s = {};
                if ("object" == typeof form) {
                    let len = elements.length;
                    for (let i = 0; i < len - 1; i++) {
                        field = elements[i].querySelector("input");
                        if ("file" != field.type && "reset" != field.type && "submit" != field.type && "button" != field.type) switch (field.type) {
                          case "square":
                            this.data[this.counter].answers[i].value = field.value;
                            s[this.data[this.counter].answers[i].answer_title] = this.data[this.counter].answers[i].value;
                            break;
                          ...
                          case "radio":
                            this.data[this.counter].answers[i].checked = field.checked ? "checked" : "";
                            if (field.checked) s[this.data[this.counter].answer_alias] = this.data[this.counter].answers[i].value;
                            break;
                          ...
                          case "number":
                            s[this.data[this.counter].answers[i].answer_title] = field.value;
                            break;
                        }
                    }
                }
        ...
        startQuiz();
        const script_form = document.querySelector(".js-form");
        const telSelector = script_form.querySelector('input[type="tel"]');
        const inputMask = new Inputmask("+7 (999) 999-99-99");
        inputMask.mask(telSelector);
        const form7 = document.querySelector(".js-form7");
        const telSelector7 = form7.querySelector('input[type="tel"]');
        inputMask.mask(telSelector7);
        const form5 = document.querySelector(".js-form5");
        const telSelector5 = form5.querySelector('input[type="tel"]');
        inputMask.mask(telSelector5);
        const form6 = document.querySelector(".js-form6");
        const telSelector6 = form6.querySelector('input[type="tel"]');
        inputMask.mask(telSelector6);
        ...
        new window.JustValidate(".js-form", {
            rules: {
                tel: {
                    ...
                    function: () => {
                        ...
                        return Number(phone) && 10 === phone.length;
                    }
                },
                street: {
                    required: true
            ...
            submitHandler: function(thisForm) {
                ...
                xhr.onreadystatechange = function() {
                    if (4 === xhr.readyState) if (200 === xhr.status) setTimeout((() => document.getElementById("send-200").click()), 1e3); else if (404 === xhr.status || 500 === xhr.status) setTimeout((() => document.getElementById("send-404").click()), 1e3);
                };
        ...
        new window.JustValidate(".js-form5", {
            rules: {
                tel: {
                    required: true,
                    function: () => {
        ...
        new window.JustValidate(".js-form6", {
            rules: {
                tel: {
                    required: true,
                    function: () => {
                        const phone = telSelector6.inputmask.unmaskedvalue();
                        return Number(phone) && 10 === phone.length;
                    }
                },
                street: {
        ...
        new window.JustValidate(".js-form2", {
            ...
            messages: {
                ...
                square: {
                    required: "Введите площадь квартиры"
                },
                price: {
                    required: "Введите стоимость квартиры"
                },
                tel: {
                    required: "Введите телефон",
                    function: "Здесь должно быть 10 символов без +7"
        ...
        new window.JustValidate(".js-form3", {
            rules: {
                tel: {
                    required: true,
                    function: () => {
        ...
        new window.JustValidate(".js-form4", {
            rules: {
                tel: {
                    required: true,
                    function: () => {
            ...
            messages: {
                ...
                time: {
                    required: "Введите время для звонка"
                },
                tel: {
                    required: "Введите телефон",
                    function: "Здесь должно быть 10 символов без +7"
        ...
        new window.JustValidate(".js-form7", {
            rules: {
                tel: {
                    required: true,
                    function: () => {
                        const phone = telSelector7.inputmask.unmaskedvalue();
                        return Number(phone) && 10 === phone.length;
                    }
                },
                street: {
